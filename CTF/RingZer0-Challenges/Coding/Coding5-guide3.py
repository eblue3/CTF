"""
The first step was to parse the punchcard image and retrieve the content. To do this I made myself a quick script
that would parse image and get me the output. This would get you:
...
The last numbers aren't part of the program, but are simply there to sort the punchcard in the right order.
The code is Fortran, so I just looked online for something that would execute Fortran code and give me the output.
I found this: http://www.tutorialspoint.com/compile_fortran_online.php which worked perfectly and gave me the flag.
