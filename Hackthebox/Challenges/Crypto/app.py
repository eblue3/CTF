...
def main(s):
	...
	# send banner message
	send_msg(s, wlcm_msg)
	# so "msg" = logged_username=USER&password=PASSWORD
	msg = 'logged_username=' + user +'&password=' + passwd
	# if user = "admin" and password = "g0ld3n_b0y" => Exit and close
	try:
	...
	# set msg again???
	msg = 'logged_username=' + user +'&password=' + passwd
	# print the encrypted message, but without change so ... what is the 16 bytes?
